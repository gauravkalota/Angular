...
class SharedService {
    constructor(http) {
        this.http = http;
        this.APIUrl = "http://localhost:59602/api";
        this.PhotoUrl = "http://localhost:59602/Photos/";
    }
    getDepList() {
...
module.exports = __webpack_require__(/*! /Users/gauravkalota/Downloads/Angular-master/src/main.ts */"./src/main.ts");
